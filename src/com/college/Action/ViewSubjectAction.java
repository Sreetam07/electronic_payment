...
public class ViewSubjectAction extends HttpServlet {
	...
	try {
	  ...
	  try{
		  ...
		  courseinfo= new CourseMgrDelegate().viewSubject();		  
		  System.out.println("in Action class vcb..........."+courseinfo);
		  if(!courseinfo.isEmpty()){
			  request.setAttribute("subjectvector", courseinfo);
			  request.setAttribute("status", "Here is  The Subjects Info");
			  path="./ViewAllSubjects.jsp";
			 }
		  else {
