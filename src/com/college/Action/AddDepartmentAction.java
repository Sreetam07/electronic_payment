		...
		String path="";
	         ...
	         try{
	        	...
	        	String login=(String) session.getAttribute("loginuser");
			       ...
			       flag= new CourseMgrDelegate().insertDepartment(cb);
			 
			   if(flag){
				   request.setAttribute("status", "Department Added Successfully");
				  path="./AddDepartment.jsp";
				 }
			  else{
				  request.setAttribute("status", "Adding of Department is Failed Or Department is Already Exist");
				  path="./userhome.jsp";
				  }}
		  catch (Exception e) {
