...
public class AddBranchAction extends HttpServlet {
		...
		String path="";
	         ...
	         try{
	        	...
	        	String login=(String) session.getAttribute("loginuser");
			       ...
			       flag= new CourseMgrDelegate().insertBranch(cb);
			 
			   if(flag){
				   request.setAttribute("status", "Branch Added Successfully");
				  path="./AddBranch.jsp";
				 }
			  else{
				  request.setAttribute("status", "Adding of Branch is Failed Or Branch is Already Exist");
				  path="./userhome.jsp";
				  }}
		  catch (Exception e) {
