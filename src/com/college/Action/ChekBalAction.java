	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			else
			{
              ...
              request.setAttribute("status", "Insufficient Balance.Please Deposite  money.");
              System.out.println("Insufficient Balance.Please Deposite  money");
              path="./PayFee.jsp";
			...
			request.setAttribute("status", "Invalid data & Please Enter Proper data");
