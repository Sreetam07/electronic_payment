...
public class UpdateFeeAction extends HttpServlet {
 ...
 public void doPost(HttpServletRequest request, HttpServletResponse response)
	...
	try {
	  ...
	  try{
		   ...
		   flag= new CourseMgrDelegate().updateFee(cb);
		 
		  System.out.println("in Action class vcb..........."+flag);
		  
		  
		  if(flag){
			  request.setAttribute("status", " Fee Updatation  is Success");
			  path="./ViewFeeAction?page=./ViewAllFee.jsp";
			 }
		  else {
			  request.setAttribute("status", "Updation of Fees is Failed ");
			  path="./ViewFeeAction?page=./ViewAllFee.jsp";
			  }
