...
public class AddFeeAction extends HttpServlet {
		...
		String path="";
	         ...
	         try{
	        	...
	        	String login=(String) session.getAttribute("loginuser");
			       ...
			       flag= new CourseMgrDelegate().insertFee(cb);
			 
			   if(flag){
				   request.setAttribute("status", "Fee Info Added Successfully");
				  path="./ViewCoursesAction?page=/AddFee.jsp";
				 }
			  else{
				  request.setAttribute("status", "Adding of Feee is Failed ");
				  path="./userhome.jsp";
				  }}
		  catch (Exception e) {
