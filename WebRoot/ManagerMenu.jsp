...
<body>
	...
	<div class="menu" >
		<ul>
			...
			<li><FONT size="2"><a href="#">Branch&amp;Course</a></FONT>
				<ul>
			...
			<li><FONT size="2"><a href="#">StudentDetails</a></FONT>
			<ul>
			...
			<li><FONT size="2"><a href="#">Feedback</a></FONT>
			<ul>
			...
			<li><FONT size="2"><a href="./RegistrationForm.jsp">Security</a></FONT>
			<ul>
