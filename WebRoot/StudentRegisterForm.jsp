...
<head>
	...
	<script type="text/javascript">
	 ...
	 function CheckAvailable()
	 {
	    ...
	    window.location.href="<%=request.getContextPath()%>/ChekUserAction?userid="+userid+"&path=./ViewCoursesAction?page=StudentRegisterForm.jsp";
	 }
...
<jsp:include page="Header.jsp"></jsp:include>
	...
	<form action="<%=request.getContextPath()+"/RegisterStudentAction"%>" method="post" name="register">
		<table width="900" align="center">
			...
			<tr bgcolor="#fffff">
				<td colspan="2" align="center">
					<font color="green" size="5"> Students Registration Form</font>
				</td>
			</tr>
			<tr>
				<td colspan="2">
   ...
   <font color="green">
			...
			<tr>
			 ...
			 <tr>
				<td colspan="2" align="left">
					<font color="blue" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;Course and Others Details</font>
				</td>
			</tr>
         ...
         <tr>
					...
					<font size="4">Branch Name</font>
                            ...
                            <option value="${branchinfo.bid }">${branchinfo.branchname }</option>
                            </c:forEach>
                            </c:if>
				...
				<td>
					...
					<option value="no">No</option>					
                         ...
                         <tr>
				<td align="center">
					<font size="4">Hostel Facility</font>
				</td>
				<td>
					<select name="hostel">
					<option>--Select One--</option>
			...
			<tr>
               ...
               <tr>
				...
				<td>
					...
					<option value="AndharaBank">AndharaBank</option>
			...
			<tr>
    <td align="center"><font size="4">Account Type</font></td>
  ...
  <tr>
    <td align="center"><font size="4">AccountBal</font></td>
    <td><input type="text" name="accbal"  value="" readonly=" "/></td>
  </tr>
