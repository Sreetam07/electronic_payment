...
setTimeout("disableBackButton()", 0);
  ...
  <br/><br/>
<form id="form1" name="rollno" method="post" action="./ViewFacultySubjectsAction">
<fieldset>
         <legend><b><font color="#A3456"><br></font></b></legend>
         <TABLE><tr><td>
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("rollno");
    ...
    frmvalidator.addValidation("userid","req","FacultyID is required");
